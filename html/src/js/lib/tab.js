...
class Tab {
  ...
  show() {
    if (this.element.parentNode &&
      ...
      $(this.element).hasClass(ClassName.DISABLED)) {
      return
    }

    let target
    let previous
    const listElement = $(this.element).closest(Selector.NAV_LIST_GROUP)[0]
    const selector = Util.getSelectorFromElement(this.element)
